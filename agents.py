...
class BasicProbabilityBot:
    ...
    def next_action(self, action, random_number):
        ...
        Arguments:
          - action (numpy int8 array): 9 element numpy int8 array of NES gamepad actions
        ...
        if random_int < self.to_jump and self.cooldowns['attack'] <= 0:
            action[8] = 1
